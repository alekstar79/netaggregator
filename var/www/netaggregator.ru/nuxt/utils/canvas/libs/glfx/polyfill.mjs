/** @see https://github.com/evanw/OES_texture_float_linear-polyfill */
(function() {
    let gl, oldGetExtension, oldGetSupportedExtensions
    ...
    */
    ...
    {
        if (gl.$OES_texture_float_linear$ === undefined) {
    ...
    {
        const extensions = oldGetSupportedExtensions.call(this)
