...
export function createBrush({ fabric })
{
    ...
    fabric.PatternBrush = fabric.util.createClass(fabric.BaseBrush, {
        color: '#000000',
        width: 30,
        ...
        getPattern()
        {
            let cnv = document.createElement('canvas'),
                ctx = cnv.getContext('2d'),
                top = this.canvas.contextTop,

                dotDistance = 5,
                dotWidth = 20

            cnv.width = cnv.height = dotWidth + dotDistance
            ...
            return top.createPattern(cnv, 'repeat')
        },
