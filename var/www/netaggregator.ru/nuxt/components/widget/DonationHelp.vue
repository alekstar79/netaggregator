<template>
    <v-layout class="pane scroller" :class="`theme--${$vuetify.theme.dark ? 'dark' : 'light'}`">
        <v-container class="pane__topic" :class="{ fullscreen, mobile }">
            <h2 class="pane__topic-title mb-5">Виджет "Пожертвования".</h2>

            <!--<p class="pane__topic-definition">
                Виджет "Пожертвования"...
            </p>-->

            <v-img class="pane__images image-01 right" @click="view(0)" :src="images[0]" />

            <p class="pane__topic-disclosure">
                Виджет "Пожертвования", встраивает блок прогресса пожертвований в группу пользователя.
                В интерфейсе модуля предусмотрены поле ввода заголовока, ссылка в футере, поле ввода
                текста виджета, слайдер установки суммы внесенных пожертвований, блок отображения и
                установки требуемой суммы сбора и валюты, а так же блок числа пожертвовавших. Все блоки
                кликабельны. Функционал настройки и кастомизации блока рассмотрен в общем для всех
                виджетов разделе справочного руководства.
            </p>
...
<script>
    ...
    export default {
        ...
        data: () => ({
            images: [
                '/img/help/widget-donation-01.png',
                '/img/help/widget-donation-02.png',
                '/img/help/widget-donation-03.png',
                '/img/help/widget-donation-04.png'
            ]
        }),
        methods: {
            view(idx)
