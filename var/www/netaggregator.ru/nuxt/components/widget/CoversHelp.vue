<template>
    <v-layout class="pane scroller" :class="`theme--${$vuetify.theme.dark ? 'dark' : 'light'}`">
        <v-container class="pane__topic" :class="{ fullscreen, mobile }">
            <h2 class="pane__topic-title mb-5">Виджет "Обложки".</h2>
            ...
            <p class="pane__topic-disclosure">
                Виджет "Обложки", встраивает блок горизонтальных баннеров (до 3-х шт.) в группу пользователя.
                В интерфейсе модуля предусмотрены поле ввода заголовока ссылка в футере и набор баннеров,
                каждый из которых позволяет загрузить изображение баннера (1530х384) и прикрепить заголовок,
                описание, настроить кнопку действия. Функционал настройки и кастомизации блока рассмотрен в
                общем для всех виджетов разделе справочного руководства.
            </p>
