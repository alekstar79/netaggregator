<template>
    <v-layout class="pane scroller" :class="`theme--${$vuetify.theme.dark ? 'dark' : 'light'}`">
        <v-container class="pane__topic" :class="{ fullscreen, mobile }">
            <h2 class="pane__topic-title mb-5">Виджет "Плитки".</h2>
            ...
            <p class="pane__topic-disclosure">
                Виджет "Плитки", встраивает блок вертикальных баннеров (до 10 шт.) в группу пользователя.
                В интерфейсе модуля предусмотрены поле ввода заголовока и набор баннеров, каждый из которых
                позволяет загрузить изображение баннера (480х480 или 480х720) и прикрепить заголовок, описание
                и ссылку. Функционал настройки и кастомизации блока рассмотрен в общем для всех виджетов
                разделе справочного руководства.
            </p>
