 ...
 * JS PORT: https://github.com/hgoebl/mobile-detect.js
 *
 * @license https://github.com/serbanghita/Mobile-Detect/blob/master/LICENSE
 * @author Serban Ghita <serbanghita@gmail.com>
 * @author Nick Ilyin <nick.ilyin@gmail.com>
 * @original_author: Victor Stanciu <vic.stanciu@gmail.com>
 *
 * @version 2.8.37
 * @package Helpers
 *
...
class MobileDetect
{
    ...
    public function setCfHeaders($cfHeaders = null): bool
    {
        ...
        foreach ($cfHeaders as $key => $value) {
            if (stripos(strtolower($key), 'http_cloudfront_') === 0) {
    ...
    {
        return $this->detectionType === self::DETECTION_TYPE_EXTENDED
            ? $this->getMobileDetectionRulesExtended()
            : self::getMobileDetectionRules();
    }
     ...
     * @return mixed
     * @throws RuntimeException when the method doesn't exist and doesn't start with 'is'
     */
    public function __call(string $name, array $arguments)
    {
        // make sure the name starts with 'is', otherwise
        if (strpos($name, 'is') !== 0) {
            throw new \RuntimeException("No such method exists: $name");
        }
