<?php # https://github.com/Insolita/unused-scanner
...
/**
* Array of full directories path for scan. Scan will be recursive
...
return [
    ...
    * The scanning time and memory usage will be increased when report mode enabled,
